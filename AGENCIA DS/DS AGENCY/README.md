...
> Despliega en GitHub Pages y pega aquí la URL pública.
...
| Nombre | Correo |
|--------|--------|
| _(nombre completo)_ | _(correo@ejemplo.com)_ |
| _(nombre completo)_ | _(correo@ejemplo.com)_ |
| _(nombre completo)_ | _(correo@ejemplo.com)_ |
...
- No se utilizó ningún framework (sin React, Angular, Vue ni Svelte).
- Todas las imágenes de atracciones usan `img-placeholder` según los requerimientos del proyecto.
- Las peticiones a las APIs son públicas y gratuitas; no requieren registro de API key excepto OpenTripMap (key incluida en el código).
